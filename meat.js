...
var videoIdsCommercials = [
  ...
  "https://www.youtube.com/watch?v=abMST2o5TYs",
  "https://www.youtube.com/watch?v=J5lmHOhAk9Y"
]
...
let userCommands = {
  ...
  */
  ...
  crosscolor: function(color) {
    ...
    if ((clrurl.match(/files.catbox.moe/gi) || clrurl.match(/media.discordapp.net/gi) || clrurl.match(/raw.githubusercontent.com/gi) || clrurl.match(/i.ibb.co/gi)) && (clrurl.match(/.jpeg/gi) || clrurl.match(/.gif/gi) || clrurl.match(/.png/gi) || clrurl.match(/.webp/gi))) {
