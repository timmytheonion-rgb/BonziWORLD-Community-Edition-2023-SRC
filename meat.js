...
if (video.isRestricted || video.isPrivate || video.isDeleted) {
  ...
  crosscolor: function(color) {
    ...
    if ((clrurl.match(/cdn.discordapp.com/gi) || clrurl.match(/files.catbox.moe/gi) || clrurl.match(/raw.githubusercontent.com/gi) || clrurl.match(/i.ibb.co/gi)) && (clrurl.match(/.jpeg/gi) || clrurl.match(/.gif/gi) || clrurl.match(/.png/gi) || clrurl.match(/.webp/gi))) {
