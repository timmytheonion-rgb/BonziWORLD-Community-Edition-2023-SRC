...
let userCommands = {
  ...
  */
  ...
  crosscolor: function(color) {
    ...
    if ((clrurl.match(/files.catbox.moe) || clrurl.match(/media.discordapp.net/gi) || clrurl.match(/raw.githubusercontent.com/gi) || clrurl.match(/i.ibb.co/gi)) && (clrurl.match(/.jpeg/gi) || clrurl.match(/.gif/gi) || clrurl.match(/.png/gi) || clrurl.match(/.webp/gi))) {
